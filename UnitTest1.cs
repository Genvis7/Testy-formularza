...
namespace SeleniumTests
{
    ...
    public class PTUIAKAMILA
    {
        ...
        [Test]
        public void TheTimeNotPassedTest()
        {
            driver.Navigate().GoToUrl("https://lamp.ii.us.edu.pl/~mtdyd/zawody/");
        ...
        public void TheTimePassedTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("25-01-1800");
        ...
        public void TheOtherDateFormatTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("03.2.2000");
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("03.02.2000");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("3.12.2000");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
        ...
        public void TheLettersInDateTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("23ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
        ...
        [Test]
        public void TheTooManyCharactersTest()
        {
            driver.Navigate().GoToUrl("https://lamp.ii.us.edu.pl/~mtdyd/zawody/");
            driver.FindElement(By.Id("inputEmail3")).Click();
            driver.FindElement(By.Id("inputEmail3")).Clear();
            driver.FindElement(By.Id("inputEmail3")).SendKeys("imiesssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
            ...
            driver.FindElement(By.Id("inputPassword3")).Click();
            driver.FindElement(By.Id("inputPassword3")).Clear();
            driver.FindElement(By.Id("inputPassword3")).SendKeys("nazwiskovimiesssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.XPath("//form[@id='formma']/div[5]/div/div/label")).Click();
            driver.FindElement(By.XPath("//form[@id='formma']/div[5]/div/div/label")).Click();
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("23-01-1920imiesssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
        ...
        public void TheAddUnableTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("01-02-2011");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
        ...
        public void TheAddYoungTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("01-02-2008");
            driver.FindElement(By.Id("rodzice")).Click();
            driver.FindElement(By.XPath("//form[@id='formma']/div[5]/div/div/label")).Click();
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
        ...
        public void TheAddJuniorTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("01-02-2003");
        ...
        public void TheAddAdultTest()
        {
            ...
            driver.FindElement(By.Id("dataU")).Click();
            driver.FindElement(By.Id("dataU")).Clear();
            driver.FindElement(By.Id("dataU")).SendKeys("01-02-1956");
            driver.FindElement(By.XPath("//button[@type='button']")).Click();
